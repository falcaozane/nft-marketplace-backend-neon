              ...
              <div className="my-5">
                ...
                {loading ? (
                  <div className="flex justify-center items-center h-64">
                    <div className="w-40 h-40 border-4 border-amber-500 border-dashed rounded-full animate-spin"></div>
                  </div>
                ) : items.length > 0 ? (
                  ...
                  <div className="text-2xl font-bold text-indigo-100 text-center my-8 py-16 h-screen">
                    No NFT Listed Now...
                  </div>
                )}
              </div>
